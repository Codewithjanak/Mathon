...
class Math:
    ...
    def generate_question(self):
        ...
        if oa == "*" :
        	self.num = f"{a} X {b}"
        	self.ans = a*b
        os = [self.ans - 1, self.ans + 2, self.ans - 3, self.ans]
...
while True :
	...
	pygame.draw.rect(screen,(173,198,255),(10,700,320,130),border_radius = 50)
	pygame.draw.rect(screen,(173,198,255),(10,900,320,130),border_radius = 50)
	pygame.draw.rect(screen,(173,198,255),(380,700,320,130),border_radius = 50)
	pygame.draw.rect(screen,(173,198,255),(380,900,320,130),border_radius = 50)
...
# question bars
	...
	if game_active == False and point >= 1:
		...
		start_t = font2.render("start",False,(255,255,255))
		screen.blit(start_t,(270,1030))
		screen.blit(score,(100,530))
		if but_J.draw(screen):
			game_active = True
			health = 3
			point = 0
			Math1.level = 1
